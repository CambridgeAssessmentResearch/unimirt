...
eplot=ggplot(data=cdata,aes(x=.data[["Ability"]],y=.data[["Expected_Score"]],col=.data[["Object"]]))+geom_line()
return(eplot)
}
...
iteplot=ggplot(data=bcoef,aes(x=.data[["C1_dif"]],y=.data[["C2_dif"]],label=.data[["names"]]))+
...
iteplot=ggplot(data=acoef,aes(x=.data[["C1_a"]],y=.data[["C2_a"]],label=.data[["Item"]]))+
